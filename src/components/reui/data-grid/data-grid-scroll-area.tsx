...
type DataGridScrollAreaOrientation = 'both' | 'horizontal' | 'vertical';
    ...
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        {showHorizontal && (
          ...
          >
            <ScrollAreaPrimitive.Thumb className={SCROLLBAR_THUMB_CLASSNAME} data-slot="data-grid-thumb" />
          </ScrollAreaPrimitive.Scrollbar>
        )}
      ...
      {usesCustomVerticalScrollbar && hasCustomVerticalOverflow && (
        <div
          aria-hidden="true"
          className="inset-e-0 top-(--data-grid-scrollbar-header-height) h-(--data-grid-scrollbar-track-height) pointer-events-none absolute z-20"
          ref={setOverlayRef}
        >
          <div
