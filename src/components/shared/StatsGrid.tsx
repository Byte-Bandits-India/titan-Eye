  ...
  const cards = [
    {
      ...
      icon: FlaskConical,
      iconBg:
        'bg-blue-50 border-blue-100 text-blue-500 dark:bg-blue-950/50 dark:border-blue-900/50 dark:text-blue-400',
      label: 'Active Tests',
    ...
    },
    {
      ...
      icon: Clock,
      iconBg:
        'bg-orange-50 border-orange-100 text-orange-500 dark:bg-orange-950/50 dark:border-orange-900/50 dark:text-orange-400',
    ...
    },
    {
      ...
      icon: CheckCircle2,
      iconBg:
        'bg-green-50 border-green-100 text-green-500 dark:bg-green-950/50 dark:border-green-900/50 dark:text-green-400',
      label: 'Completed',
    ...
    },
    {
      ...
      icon: Users2,
      iconBg:
        'bg-teal-50 border-teal-100 text-teal-500 dark:bg-teal-950/50 dark:border-teal-900/50 dark:text-teal-400',
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {cards.map((card) => {
        ...
        return (
          <Card
            className={`border-[1.5px] p-4 ${card.border} bg-card ${card.shadow} flex items-center gap-3 transition-all duration-300`}
            key={card.label}
          >
            <div
              className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border ${card.iconBg}`}
            >
              <Icon size={20} />
            </div>
