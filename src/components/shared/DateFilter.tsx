  ...
  return (
    <div className={cn('min-w-[130px] shrink-0', className)}>
      <Select onValueChange={(val) => onChange(val as DateFilterRange)} value={value}>
        <SelectTrigger className="border-border/80 shadow-xs flex h-10 cursor-pointer items-center justify-between gap-2.5 rounded-md border bg-card px-4 text-xs font-bold outline-none transition-all hover:border-blue-300 focus:ring-0 dark:hover:border-blue-700">
