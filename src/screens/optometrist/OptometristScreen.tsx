    ...
    const allColumns: ColumnDef<DataGridFeatures, Customer>[] = [
      {
        ...
        enableSorting: false,
        header: () => <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">ID</span>,
        id: 'id',
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <span className="text-sm font-normal text-foreground">{row.original.storeName || '—'}</span>
        ),
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">Store Code</span>
        ),
        id: 'storeName',
        meta: { cellClassName: 'py-3' },
        size: 130,
      },
      {
        ...
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-base font-normal text-muted-foreground">Waiting Time</span>
        ),
        id: 'timeStarted',
        meta: { cellClassName: 'py-3' },
        size: 120,
      },
      {
        ...
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-base font-normal text-muted-foreground">Call Duration</span>
        ),
        id: 'callDuration',
        meta: { cellClassName: 'py-3' },
        size: 120,
      },
      {
        ...
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">Age</span>
        ),
        id: 'age',
        meta: { cellClassName: 'py-3' },
        size: 60,
          ...
          return (
            <div className="flex items-center gap-2.5">
              <Avatar className="h-8 w-8 shrink-0">
                <AvatarFallback className="bg-teal-100 text-sm font-normal text-teal-700 dark:bg-teal-900/40 dark:text-teal-300">
                  {initials}
                </AvatarFallback>
              </Avatar>
              <span className="text-sm font-normal text-foreground">{titleCaseName}</span>
            </div>
          );
        },
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">Name</span>
        ),
        id: 'name',
        meta: { cellClassName: 'py-3' },
        size: 190,
          ...
          return (
            <div className="flex flex-wrap gap-1">
              {languages.length > 0 ? (
                languages.map((lang) => (
                  <span
                    className="inline-flex rounded-md border border-slate-200 bg-slate-100 px-2 py-0.5 text-sm font-normal text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300"
                    key={lang}
                  >
                    {lang}
                  </span>
      ...
      },
      {
        cell: ({ row }) => {
          ...
          return (
            <span
              className={cn(
                'inline-flex rounded-md border px-2.5 py-0.5 text-sm font-normal',
        ...
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">Priority</span>
        ),
        id: 'priority',
        meta: { cellClassName: 'py-3' },
        size: 110,
      ...
      },
      {
        ...
        enableSorting: false,
        header: () => (
          <span className="whitespace-nowrap text-sm font-normal text-muted-foreground">Status</span>
        ),
        id: 'status',
        meta: { cellClassName: 'py-3' },
        size: 110,
      },
      {
        ...
        enableSorting: false,
        header: () => (
          <span className="block whitespace-nowrap pr-4 text-right text-sm font-normal text-muted-foreground">
            Action
          </span>
        ),
        id: 'actions',
