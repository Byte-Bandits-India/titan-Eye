    ...
    () => [
      {
        ...
        headerClassName: 'w-[80px] whitespace-nowrap text-xs font-semibold uppercase tracking-wider text-muted-foreground',
        id: 'id',
        label: 'ID',
        render: (cust) => cust.id,
      },
      ...
      },
      {
        ...
        headerClassName: 'whitespace-nowrap text-center text-xs font-semibold uppercase tracking-wider text-muted-foreground',
        id: 'report',
        label: 'Report',
        render: (cust) => (
          <Button
            className="h-7 cursor-pointer gap-1 rounded-[50px] border-blue-200 bg-blue-50 px-2.5 text-xs font-medium text-blue-700 transition-all hover:bg-blue-100 active:scale-95 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-300 dark:hover:bg-blue-900/50"
