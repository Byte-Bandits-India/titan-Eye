    ...
    () => [
      {
        ...
        headerClassName: 'w-[80px] whitespace-nowrap text-sm font-semibold   text-muted-foreground',
        id: 'id',
        label: 'ID',
        render: (cust) => cust.id,
      },
      ...
      },
      {
        ...
        headerClassName: 'whitespace-nowrap text-center text-sm font-semibold   text-muted-foreground',
        id: 'report',
        label: 'Report',
        render: (cust) => (
          <Button
